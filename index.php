...
/* Template Name: Archives */
 get_header(); 
?>
<main id="main" class="site-main alignleft content-area archives <?php if(!lark_active_sidebars()){ echo 'full-width';}?>" role="main">
  <?php if ( have_posts() ) { 
			if(is_author()){
        ?>
  ...
  <header class="page-header">
    ...
    <h1 class="page-title">
      <?php
			 ...
			 printf( esc_html__( 'Searching for: "%s"', 'lark' ), get_search_query() );?>
    </h1>
    <?php }else{
  ...
  <?php
	...
	the_posts_pagination( array(
				'mid_size' => 5,
				'prev_text'          => esc_html__( 'Previous page', 'lark' ),
				'next_text'          => esc_html__( 'Next page', 'lark' ),
				'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page:', 'lark' ) . ' </span>',
				'screen_reader_text' =>  esc_html__( 'Pagination', 'lark' ) 
	) );
}else {
