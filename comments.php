	...
	{ ?>
		...
		<h3 class="res_title" ><?php _e('Leave a Comment','lj'); ?></h3>
		...
		<table cellpadding="0" cellspacing="0" >
		  ...
		  <td width="100%" >
			...
			<span class="req">*</span> <small>Required. </small> <span class="req">**</span><small>will not be published.</small></td>
			</tr>
			</table>
	...
	<div id="comments">	
	<h3 class="comment_title"><?php comments_number(__('No Comments.','lj'),  __('1 Comment.','lj'), '% '.__('Comments.','lj').'');?></h3>
